(function() {
    ...
    const sites = {
        ...
        '188bet':   { codexn: 'taodeptrai', url: 'https://165.22.63.250/keo-malaysia-la-gi/', loai_traffic: 'https://165.22.63.250/', span_id: 'layma_me_vuatraffic', api_file: 'GET_MA.php', param: 'codexn' },
